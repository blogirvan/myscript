$( function() {
    ...
    var trafficSound = new buzz.sound( 'http://tympanus.net/Tutorials/FullscreenSlideshowAudio/sounds/traffic' ),
        clickSound = new buzz.sound( 'http://tympanus.net/Tutorials/FullscreenSlideshowAudio/sounds/click' ),
        focusSound = new buzz.sound( 'http://tympanus.net/Tutorials/FullscreenSlideshowAudio/sounds/focus' ),
        rewindSound = new buzz.sound( 'http://tympanus.net/Tutorials/FullscreenSlideshowAudio/sounds/rewind' ),
